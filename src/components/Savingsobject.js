...
const Savingsobject = () => {
    ...
    return(
        <div className="container">
            ...
            {
           loadTransactionObject.map((TransactionObject, i) => (<div className='col-8'> <Transaction key={i} display_data={TransactionObject} /></div>
            )) 
        }
            </div>
